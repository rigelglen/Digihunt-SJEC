...
function onPuzzleClick(e) {
  if (e.layerX || e.layerX == 0) {
    _mouse.x = e.layerX - _canvas.offsetLeft + 60;
    _mouse.y = e.layerY - _canvas.offsetTop + 150;
    console.log('a');
...
function updatePuzzle(e) {
  ...
  for (i = 0; i < _pieces.length; i++) {
    ...
    if (_currentDropPiece == null) {
      if (_mouse.x < piece.xPos || _mouse.x > piece.xPos + _pieceWidth || _mouse.y < piece.yPos || _mouse.y > piece.yPos + _pieceHeight) {//NOT OVER
      } else {
