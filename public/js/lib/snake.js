    ...
    */
    ...
    return function (inputConfig) {
        ...
        function createWelcomeElement() {
            ...
            welcomeTxt.innerHTML = "You are a Snake<p></p>Use the <strong>arrow keys</strong> on your keyboard to relive your memories. " + fullScreenText + "<p></p>";
            var welcomeStart = document.createElement("button");
            welcomeStart.appendChild(document.createTextNode("GO"));
        ...
        function createTryAgainElement() {
            ...
            tryAgainStart.appendChild(document.createTextNode("Try Again?"));
